...
describe('shipmentDraftService', function() {

    var SHIPMENT_DRAFT_ENDPOINT = '/api/shipmentDrafts';

    var shipmentDraftService, $httpBackend, PageDataBuilder, fulfillmentUrlFactory, $rootScope,
    ...
    describe('search', function() {
        ...
        it('should resolve to returned page', function() {
            $httpBackend
            .expectGET(fulfillmentUrlFactory(SHIPMENT_DRAFT_ENDPOINT))
        ...
        it('should pass parameters', function() {
            ...
            $httpBackend
            .expectGET(fulfillmentUrlFactory(SHIPMENT_DRAFT_ENDPOINT + '?orderId=' + orderId))
            .respond(200, response);
    ...
    describe('remove', function() {
        ...
        it('should resolve if successfully removed', function() {
            $httpBackend
            .expectDELETE(fulfillmentUrlFactory(SHIPMENT_DRAFT_ENDPOINT + '/' + shipmentId))
            .respond(200);

            var success;
            shipmentDraftService.remove(shipmentId)
            .then(function() {
                success = true;
            });
            $rootScope.$apply();
    ...
    describe('save', function() {
        ...
        it('should resolve if successfully created', function() {
            ...
            $httpBackend
            .expectPOST(fulfillmentUrlFactory(SHIPMENT_DRAFT_ENDPOINT), shipment)
            .respond(200, response);
        ...
        it('should resolve if successfully updated', function() {
            $httpBackend
            .expectPUT(fulfillmentUrlFactory(SHIPMENT_DRAFT_ENDPOINT + '/' + shipment.id), shipment)
            .respond(200, response);
        ...
        it('should throw exception if shipment is not given', function() {
            expect(function() {
                shipmentDraftService.save();
            }).toThrow('Shipment draft must be defined');
        });
    });
